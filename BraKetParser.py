...
class BraKetParser ( Parser ):
    ...
    class ProgContext(ParserRuleContext):
        ...
        def expr(self):
            return self.getTypedRuleContext(BraKetParser.ExprContext,0)
    ...
    def prog(self):
        ...
        localctx = BraKetParser.ProgContext(self, self._ctx, self.state)
    ...
    class ExprContext(ParserRuleContext):
        ...
        def expr(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(BraKetParser.ExprContext)
            else:
                return self.getTypedRuleContext(BraKetParser.ExprContext,i)


        def getRuleIndex(self):
            return BraKetParser.RULE_expr
    ...
    def expr(self, _p:int=0):
        ...
        localctx = BraKetParser.ExprContext(self, self._ctx, _parentState)
        _prevctx = localctx
        _startState = 2
        ...
        try:
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = BraKetParser.ExprContext(self, _parentctx, _parentState)
