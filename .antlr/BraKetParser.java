...
public class BraKetParser extends Parser {
	...
	public static final int
		COMMA=1, WS=2, LINE_COMMENT=3, BLOCK_COMMENT=4, FROM=5, IMPORT=6, CONST=7, 
		KET_IDENTIFIER=8, BRA_IDENTIFIER=9, INT=10, FLOAT=11, CHAR=12, STRING=13, 
		COMPLEX=14, RETURN=15, IF=16, ELIF=17, ELSE=18, FOR=19, WHILE=20, DO=21, 
		BOOL_TRUE=22, BOOL_FALSE=23, MAIN=24, FUNC=25, ADD=26, SUB=27, AMPERSAND=28, 
		MUL=29, DIV=30, EXP=31, MOD=32, ASSIGN=33, GT=34, LT=35, GTE=36, LTE=37, 
		EQ=38, NEQ=39, LOGICAL_OR=40, LOGICAL_AND=41, NEG=42, LPAREN=43, RPAREN=44, 
		LSQUARE=45, RSQUARE=46, LCURLY=47, RCURLY=48, TENSOR=49, SEMICOLON=50, 
		DOT=51, IDENTIFIER=52;
	public static final int
		...
		RULE_var_decl = 7, RULE_value = 8, RULE_braket_vector = 9, RULE_braket_expression = 10, 
		RULE_braket_term = 11, RULE_braket_factor = 12, RULE_array = 13, RULE_struct = 14, 
		RULE_struct_value = 15, RULE_op = 16, RULE_statement_list = 17, RULE_statement = 18, 
		RULE_assign_statement = 19, RULE_func_call_statement = 20, RULE_arg_list = 21, 
		RULE_arg = 22, RULE_return_statement = 23, RULE_if_statement = 24, RULE_elif = 25, 
		RULE_else = 26, RULE_for_statement = 27, RULE_while_statement = 28, RULE_do_statement = 29, 
		RULE_expression = 30, RULE_string_expression = 31, RULE_num_expression = 32, 
		RULE_num_term = 33, RULE_num_factor = 34, RULE_array_access = 35, RULE_struct_access = 36, 
		RULE_dirac_expression = 37, RULE_num_comp = 38, RULE_eq_comp = 39, RULE_bool_expression = 40, 
		RULE_bool_or = 41, RULE_bool_and = 42, RULE_bool_cmp = 43, RULE_bool_unary = 44, 
		RULE_bool_primary = 45, RULE_func_decl_list = 46, RULE_func_decl = 47, 
		RULE_param_list = 48, RULE_identifier_list = 49, RULE_default_list = 50, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"braket_expression", "braket_term", "braket_factor", "array", "struct", 
			"struct_value", "op", "statement_list", "statement", "assign_statement", 
			"func_call_statement", "arg_list", "arg", "return_statement", "if_statement", 
			"elif", "else", "for_statement", "while_statement", "do_statement", "expression", 
			"string_expression", "num_expression", "num_term", "num_factor", "array_access", 
			"struct_access", "dirac_expression", "num_comp", "eq_comp", "bool_expression", 
			"bool_or", "bool_and", "bool_cmp", "bool_unary", "bool_primary", "func_decl_list", 
			"func_decl", "param_list", "identifier_list", "default_list", "main_function"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "','", null, null, null, "'from'", "'import'", "'const'", null, 
			null, null, null, null, null, null, "'return'", "'if'", "'elif'", "'else'", 
			"'for'", "'while'", "'do'", "'true'", "'false'", "'main'", "'func'", 
			"'+'", "'-'", "'&'", "'*'", "'/'", "'**'", "'%'", "'='", "'>'", "'<'", 
			"'>='", "'<='", "'=='", "'!='", "'||'", "'&&'", "'!'", "'('", "')'", 
			"'['", "']'", "'{'", "'}'", "'@'", "';'", "'.'"
		};
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "COMMA", "WS", "LINE_COMMENT", "BLOCK_COMMENT", "FROM", "IMPORT", 
			"CONST", "KET_IDENTIFIER", "BRA_IDENTIFIER", "INT", "FLOAT", "CHAR", 
			"STRING", "COMPLEX", "RETURN", "IF", "ELIF", "ELSE", "FOR", "WHILE", 
			"DO", "BOOL_TRUE", "BOOL_FALSE", "MAIN", "FUNC", "ADD", "SUB", "AMPERSAND", 
			"MUL", "DIV", "EXP", "MOD", "ASSIGN", "GT", "LT", "GTE", "LTE", "EQ", 
			"NEQ", "LOGICAL_OR", "LOGICAL_AND", "NEG", "LPAREN", "RPAREN", "LSQUARE", 
			"RSQUARE", "LCURLY", "RCURLY", "TENSOR", "SEMICOLON", "DOT", "IDENTIFIER"
		};
	}
	...
	public static class ProgramContext extends ParserRuleContext {
		public TerminalNode EOF() { return getToken(BraKetParser.EOF, 0); }
	...
	public final Var_decl_listContext var_decl_list() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 4503599627371264L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class Braket_vectorContext extends ParserRuleContext {
		...
		public List<Braket_expressionContext> braket_expression() {
			return getRuleContexts(Braket_expressionContext.class);
		}
		public Braket_expressionContext braket_expression(int i) {
			return getRuleContext(Braket_expressionContext.class,i);
		}
		public List<TerminalNode> COMMA() { return getTokens(BraKetParser.COMMA); }
		public TerminalNode COMMA(int i) {
			return getToken(BraKetParser.COMMA, i);
	...
	public final Braket_expressionContext braket_expression() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_braket_expression);
		try {
			setState(197);
			_errHandler.sync(this);
	...
	public final Braket_termContext braket_term() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_braket_term);
		try {
			setState(216);
			_errHandler.sync(this);
	...
	public final Braket_factorContext braket_factor() throws RecognitionException {
		...
		enterRule(_localctx, 24, RULE_braket_factor);
		try {
			setState(231);
			_errHandler.sync(this);
	...
	public final ArrayContext array() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4692716646596352L) != 0)) {
				{
				setState(234);
				expression();
				setState(239);
	...
	public final StructContext struct() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 4503599660925696L) != 0)) {
				{
				setState(247);
				struct_value();
				}
	...
	public final Struct_valueContext struct_value() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_struct_value);
		try {
			setState(262);
			_errHandler.sync(this);
	...
	public final Statement_listContext statement_list() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 4503600168010496L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final Func_call_statementContext func_call_statement() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_func_call_statement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Do_statementContext do_statement() throws RecognitionException {
		...
		enterRule(_localctx, 58, RULE_do_statement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(379);
	...
	public final Num_expressionContext num_expression() throws RecognitionException {
		...
		enterRule(_localctx, 64, RULE_num_expression);
		try {
			setState(422);
			_errHandler.sync(this);
	...
	public static class Num_factorContext extends ParserRuleContext {
		...
		public TerminalNode SUB() { return getToken(BraKetParser.SUB, 0); }
		public TerminalNode AMPERSAND() { return getToken(BraKetParser.AMPERSAND, 0); }
		public TerminalNode IDENTIFIER() { return getToken(BraKetParser.IDENTIFIER, 0); }
		public TerminalNode MUL() { return getToken(BraKetParser.MUL, 0); }
		public TerminalNode INT() { return getToken(BraKetParser.INT, 0); }
		public TerminalNode FLOAT() { return getToken(BraKetParser.FLOAT, 0); }
	...
	public final Struct_accessContext struct_access() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_struct_access);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	private Dirac_expressionContext dirac_expression(int _p) throws RecognitionException {
		...
		int _startState = 74;
		enterRecursionRule(_localctx, 74, RULE_dirac_expression, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Eq_compContext eq_comp() throws RecognitionException {
		...
		enterRule(_localctx, 78, RULE_eq_comp);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Bool_expressionContext bool_expression() throws RecognitionException {
		...
		enterRule(_localctx, 80, RULE_bool_expression);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(510);
	...
	private Bool_orContext bool_or(int _p) throws RecognitionException {
		...
		int _startState = 82;
		enterRecursionRule(_localctx, 82, RULE_bool_or, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	private Bool_andContext bool_and(int _p) throws RecognitionException {
		...
		int _startState = 84;
		enterRecursionRule(_localctx, 84, RULE_bool_and, _p);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Func_decl_listContext func_decl_list() throws RecognitionException {
		...
		enterRule(_localctx, 92, RULE_func_decl_list);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Func_declContext func_decl() throws RecognitionException {
		...
		enterRule(_localctx, 94, RULE_func_decl);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Default_listContext default_list() throws RecognitionException {
		...
		enterRule(_localctx, 100, RULE_default_list);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Main_functionContext main_function() throws RecognitionException {
		...
		enterRule(_localctx, 102, RULE_main_function);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
