...
class BraKetVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by BraKetParser#braket_elements.
    def visitBraket_elements(self, ctx:BraKetParser.Braket_elementsContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BraKetParser#element_list.
    def visitElement_list(self, ctx:BraKetParser.Element_listContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BraKetParser#op_list.
    def visitOp_list(self, ctx:BraKetParser.Op_listContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BraKetParser#op_value.
    def visitOp_value(self, ctx:BraKetParser.Op_valueContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by BraKetParser#bool_logical.
    def visitBool_logical(self, ctx:BraKetParser.Bool_logicalContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BraKetParser#bool_term.
    def visitBool_term(self, ctx:BraKetParser.Bool_termContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by BraKetParser#bool_factor.
    def visitBool_factor(self, ctx:BraKetParser.Bool_factorContext):
        return self.visitChildren(ctx)
